...
# pull docker app
sudo docker pull 065882805973.dkr.ecr.eu-west-2.amazonaws.com/engagement-app:latest

# run docker app
sudo docker run -d -p 80:80 --name engagement-app 065882805973.dkr.ecr.eu-west-2.amazonaws.com/engagement-app:latest
